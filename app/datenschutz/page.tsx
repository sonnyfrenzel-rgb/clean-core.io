      ...
      <main className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="space-y-10 text-gray-700 leading-relaxed">
          ...
          <section id="cookies" className="scroll-mt-20">
            ...
            <p className="text-base mb-3">
              Signing in adds two things, both on your own device. Google Firebase Authentication keeps your session in your browser&apos;s <strong>IndexedDB</strong> so you stay signed in between visits; without it you would have to sign in on every page. And the interface remembers your own choices, in local storage: which hints you have dismissed (<code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded">cc.workspace.coachMarks.dismissed</code>), whether you have seen the first look (<code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded">cc.workspace.firstLook.seen</code>) and the introduction in the new-project dialog (<code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded">cc.newProject.introSeen</code>), how you left the demo (<code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded">cleancore.demo.v1</code>), and which sign-off banner you closed (<code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded">signoff-banner-dismissed-…</code>). In session storage, which your browser drops when you close it: a dismissed pilot banner, a guard that stops a failed page from reloading in a loop, and — if you set aside a notice that the Terms have changed — which version you set aside (<code className="text-sm font-mono bg-gray-100 px-1.5 py-0.5 rounded">cc.terms.declined.…</code>), so you are asked again the next time you sign in rather than on every page.
            </p>
            <p className="text-base">
