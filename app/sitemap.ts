...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/clean-core-explained`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${baseUrl}/reference-analysis`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
