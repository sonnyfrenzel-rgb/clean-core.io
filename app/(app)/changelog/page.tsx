...
const releases = [
  ...
  },
  {
    ...
    changes: [
      ...
      'Implemented Firestore-backed API rate limiting on Gemini, MFA, access request, and tenant request endpoints',
  ...
  },
  {
    ...
    changes: [
      ...
      'Mitigated potential HTML injection threats by fully sanitizing welcome and administrator approval email templates',
  ...
  },
  {
    ...
    changes: [
      ...
      'Created realistic ABAP OO / SQL Join test script balloon in the workspace for testing',
  ...
  },
  {
    ...
    changes: [
      ...
      'Updated footer and banner links to real legal routes',
