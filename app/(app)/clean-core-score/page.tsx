  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 space-y-12 animate-in fade-in duration-300 bg-white min-h-screen text-gray-900 font-sans">
      ...
      <QuickAnswer 
        ...
        answer="The SAP Clean Core Score is a KPI that measures the degree of decoupling between custom code extensions and the standard ERP core. Calculated with deterministic static analysis (token- and rule-based) of the code and its data dependencies, the score weights direct database modifications, calls to unreleased APIs, and key-user extensibility. A high score (closer to 100%) indicates modular code that supports upgrade readiness assessment, simplifies maintenance, and can meaningfully reduce the Total Cost of Ownership (TCO) of custom code over time."
      />
