...
## Structure
${isModular ? `- srv/service.ts: Modernized application logic.
- db/schema.cds: Database schema & entities.
...
`);
      ...
      if (docs) {
        if (project.analysis) docs.file("business-analysis.md", project.analysis);
        if (project.solutionDesign) docs.file("solution-design.md", project.solutionDesign);
        if (project.documentation) docs.file("process-blueprint.md", project.documentation);
      }
        ...
        <div className="bg-gray-900 rounded-3xl shadow-2xl p-6 md:p-10 flex flex-col items-start text-left relative overflow-hidden group">
          ...
          <ul className="space-y-4 mb-8 md:mb-10 flex-grow w-full">
            <li className="flex items-start gap-3 text-gray-400 text-xs md:text-sm font-medium">
              ...
              <div>
                <span className="text-white block font-bold">Transformed CAP Structure</span>
                <span className="text-[10px] text-gray-400">Handover: Modular TypeScript package generated</span>
              </div>
            </li>
            <li className="flex items-start gap-3 text-gray-400 text-xs md:text-sm font-medium">
              <CheckCircle2 size={18} className="text-green-400 mt-0.5 shrink-0" />
              <div>
                <span className="text-white block font-bold">{project?.testCases?.length || 10} Automated Tests</span>
                <span className="text-[10px] text-gray-400">Sandbox: TAP-reporter unit tests verified</span>
              </div>
            </li>
            <li className="flex items-start gap-3 text-gray-400 text-xs md:text-sm font-medium">
              <CheckCircle2 size={18} className="text-green-400 mt-0.5 shrink-0" />
              <div>
                ...
                <span className="text-[10px] text-gray-400">Quality: Strongly-typed model boundaries compliant</span>
              </div>
            </li>
            <li className="flex items-start gap-3 text-gray-400 text-xs md:text-sm font-medium">
              <CheckCircle2 size={18} className="text-green-400 mt-0.5 shrink-0" />
