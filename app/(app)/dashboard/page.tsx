            ...
            <div className="space-y-4 text-sm text-gray-600 leading-relaxed font-medium">
              ...
              <div className="space-y-2.5">
                ...
                <ul className="space-y-2 pl-4 list-disc text-xs text-gray-600">
                  ...
                  <li><strong>Experience sandbox testing:</strong> Watch the generated TypeScript code run automated unit tests in a restricted runner with live logs.</li>
                </ul>
              </div>
