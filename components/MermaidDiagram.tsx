  ...
  useEffect(() => {
    ...
    const renderChart = async () => {
      try {
        ...
        // Chart content is deterministically generated by our code (not user input),
        // so we can safely assign the SVG directly. DOMPurify was stripping
        // foreignObject HTML children that Mermaid needs for labels.
        if (ref.current) {
