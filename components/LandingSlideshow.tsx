...
const slides = [
  ...
  },
  {
    ...
    description: 'Technical and Business blueprints with BPMN export, Confluence integration, and SAP Signavio / SAP Build validated process documentation.',
  ...
  },
  {
    ...
    description: 'The transformation lifecycle is complete. Modernized Node.js application, comprehensive process documentation, and all deliverables — ready for deployment.',
    icon: <Download className="w-6 h-6" />,
    image: '/screenshots/step-6.jpg',
    alt: 'Clean-Core.io Project Handover page confirming the transformation lifecycle is complete with modernized Node.js application and documentation ready for deployment.',
