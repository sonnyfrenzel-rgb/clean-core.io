...
import { 
  ...
  Download, Award, ArrowRight, HelpCircle,
...
export default function HowToClient() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="w-full md:w-2/5 h-auto md:h-full relative bg-white p-6 sm:p-8 flex flex-col justify-between overflow-visible md:overflow-y-auto min-w-0">
                <div className="space-y-6">
                  <div className="space-y-1.5">
                    <span className="bg-green-50 border border-green-200 text-green-700 rounded-lg font-black uppercase tracking-wider px-2 py-0.5 text-[8px]">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <ChevronRight 
                                size={12} 
                                className={`text-slate-450 shrink-0 transition-transform duration-200 ${isHotspotActive ? 'rotate-90 text-green-650' : ''}`}
                              />
                            </div>
        ...
        <div className="bg-gradient-to-b from-white to-green-50/10 rounded-[2.5rem] p-8 shadow-xl border border-gray-100 space-y-6">
          ...
          <div className="space-y-5">
            <div className="flex gap-3">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-sm text-gray-900 font-black">Upload ABAP</h4>
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-sm text-gray-900 font-black">Review Architecture</h4>
      ...
      {/* Full-Width Core Concepts */}
      <div className="lg:col-span-4 bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-slate-800 space-y-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 pt-4">
          {concepts.map((concept, i) => (
            <div key={i} className="bg-slate-955/60 border border-slate-805/80 rounded-3xl p-6 md:p-8 space-y-6 hover:border-green-500/30 transition-all duration-300 flex flex-col justify-between group">
