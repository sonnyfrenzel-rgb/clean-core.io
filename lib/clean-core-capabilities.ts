...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    output: 'Test cases against the transformed logic: for CAP, run against mocks in a restricted Node.js process with per-case results; for ABAP Cloud, ABAP Unit classes whose run is simulated and never counted as passed. Tests against a connected tenant are locked.',
    benefit:
